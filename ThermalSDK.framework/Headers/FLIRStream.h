 ...
 */
@property (nonatomic, strong) id<FLIRStreamDelegate> delegate;
...
/**
 * Get the camera's streamed frame rate.
 */
- (double)getFrameRate;
...
/**
 * Get the highest possible frame rate for this camera stream.
 */
