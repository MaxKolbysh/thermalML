...
typedef NS_OPTIONS(NSUInteger, FLIRCommunicationInterface) {
    ...
    /// Earhart camera.
    FLIRCommunicationInterfaceEarhart = 0x400,
...
typedef NS_ENUM(NSInteger, FLIRCameraType) {
    ...
    FLIRCameraType_generic,
    /// FLIR ONE pluggable camera.
    FLIRCameraType_flirOne,

    // FLIR ONE Edge wireless camera.
    FLIRCameraType_flirOneEdge,

//    /// FLIR ONE Edge Pro wireless camera.
    FLIRCameraType_flirOneEdgePro,
    /// Earhart camera.
    FLIRCameraType_earhart,
    /// Unknown type of camera.
    FLIRCameraType_unknown
